...
/***/ function(module, exports, __webpack_require__) {
	...
	var _gameActions = __webpack_require__(182);
	...
	store.dispatch((0, _gameActions.initGameBoard)());
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _gameReducer = __webpack_require__(179);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reducerHelper = __webpack_require__(181);
	...
	function gameReducer() {
	  ...
	  switch (action.type) {
	    ...
	    case _actionConstants.REVEAL_CELL:
	      var updatedMinefield = state.minefield.slice();
	      var newCell = updatedMinefield[action.row][action.col];
	      newCell.isRevealed = true;
	      updatedMinefield[action.row][action.col] = newCell;
	      return Object.assign({}, state, {
	        minefield: [].concat(_toConsumableArray(updatedMinefield))
	      });
	
	    case _actionConstants.REVEAL_ALL_CELLS:
	      var revealMinefield = (0, _reducerHelper.revealMinefieldCells)(state.minefield);
	      return Object.assign({}, state, {
...
/***/ function(module, exports) {
	...
	function calculateCellValues(minefield, row, col) {
	  var adjacentMines = 0;
	  var cell = getCellInfo(minefield, row, col);
	
	  if (!cell || cell.contains === 'M') {
	    return;
	  }
	
	  var topCell = getCellInfo(minefield, row - 1, col);
	  if (topCell && topCell.contains === 'M') {
	    adjacentMines++;
	  }
	
	  var topLeftCell = getCellInfo(minefield, row - 1, col - 1);
	  if (topLeftCell && topLeftCell.contains === 'M') {
	    adjacentMines++;
	  }
	
	  var topRightCell = getCellInfo(minefield, row - 1, col + 1);
	  if (topRightCell && topRightCell.contains === 'M') {
	    adjacentMines++;
	  }
	
	  var leftCell = getCellInfo(minefield, row, col - 1);
	  if (leftCell && leftCell.contains === 'M') {
	    adjacentMines++;
	  }
	
	  var rightCell = getCellInfo(minefield, row, col + 1);
	  if (rightCell && rightCell.contains === 'M') {
	    adjacentMines++;
	  }
	
	  var bottomCell = getCellInfo(minefield, row + 1, col);
	  if (bottomCell && bottomCell.contains === 'M') {
	    adjacentMines++;
	  }
	
	  var bottomLeftCell = getCellInfo(minefield, row + 1, col - 1);
	  if (bottomLeftCell && bottomLeftCell.contains === 'M') {
	    adjacentMines++;
	  }
	
	  var bottomRightCell = getCellInfo(minefield, row + 1, col + 1);
	...
	function getCellInfo(minefield, row, col) {
	...
	function revealMinefieldCells(minefield) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var actions = _interopRequireWildcard(_actionConstants);
	...
	function checkCellContents(row, col) {
	  return function (dispatch, getState) {
	    var minefield = getState().game.minefield;
	
	    var cell = (0, _reducerHelper.getCellInfo)(minefield, row, col);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _boardContainer = __webpack_require__(184);
	...
	function mapDispatchToProps(dispatch) {
	  return {
	    onCellClick: function onCellClick(row, col) {
	      dispatch((0, _gameActions.checkCellContents)(row, col));
	    },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _boardTile = __webpack_require__(186);
	
	var _boardTile2 = _interopRequireDefault(_boardTile);
	
	var _gameMsg = __webpack_require__(187);
	
	var _gameMsg2 = _interopRequireDefault(_gameMsg);
	
	var _gameButton = __webpack_require__(188);
	...
	var Board = function Board(_ref) {
	  ...
	  return _react2.default.createElement(
	    'div',
	    { className: 'container' },
	    _react2.default.createElement(_gameMsg2.default, { gameMsg: gameMsg }),
	        ...
	        minefield.map(function (row, rowIndex) {
	          return _react2.default.createElement(
	            ...
	            row.map(function (cell, colIndex) {
	              return _react2.default.createElement(
	                'td',
	                { key: '' + rowIndex + ',' + colIndex, 'data-row': rowIndex, 'data-col': colIndex },
	                _react2.default.createElement(_boardTile2.default, { cellData: cell, onCellClick: onCellClick })
	              );
	            })
	          );
	        })
...
/***/ function(module, exports, __webpack_require__) {
	...
	var BoardTile = function BoardTile(_ref) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var GameMsg = function GameMsg(_ref) {
	  var gameMsg = _ref.gameMsg;
	
	  return _react2.default.createElement(
	    'div',
	    null,
	    gameMsg !== '' ? _react2.default.createElement(
	      'h2',
	      null,
	      gameMsg
	    ) : ''
